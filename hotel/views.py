...
def placeorder(request):
    if request.method == 'POST':
        ...
        api_key = 'sk_test_03185958cad1c48ab628d15f5616b4fea288b330' #This is from paystack
        ...
        cburl = 'http://18.218.173.202/paidorder' #This ip '18.218.173.202' address is from the one i got from AWS.
